...
const createNewSong = async () => {
    const created = await SongService.create({ title: 'Untitled Song' });
    await router.push({ name: 'LyricAnalyzer', params: { songId: created.id } });
};
        ...
        <div class="page-header">
            <div class="header-content">
                <div class="title-section">
                    ...
                    <h1>Editor</h1>
                    <p class="subtitle">Select or create a song project</p>
                </div>
                <button @click="createNewSong" class="create-btn primary">+ Create New Song</button>
            </div>
        </div>
                        ...
                        <div class="card-info">
                            ...
                            <div class="card-meta">
                                <div class="meta-item">
                                    ...
                                    <span class="meta-value">{{ formatDate(song.updatedAt) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
